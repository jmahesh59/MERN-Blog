...
const {loading ,error:errorMessage} = useSelector((state)=>state.user)
 ...
 const navigate = useNavigate();
  ...
  const handleSubmit =async(e)=>{
    e.preventDefault();
    if( !formData.email || !formData.password) return disptch(signInFailure("please fill out all fields"))
    try {
      disptch(signInStart())
    ...
    <div className='min-h-screen mt-20'>
       <div className="flex flex-col p-3 max-w-3xl mx-auto md:flex-row md:items-center gap-5">
            ...
            <div className="flex-1">
               ...
               <p className='text-sm mt-5'>This is an demo project . You can sign in with your email and password or with Google</p>
            </div>
              {/* {right} */}
