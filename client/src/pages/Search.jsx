        ...
        <div className="p-7 border-b md:border-r md:min-h-screen border-gray-500">
            <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
                ...
                <div className="flex gap-2 items-center">
                    <label htmlFor="font-semibold">Sort :</label>
                ...
                <div className="flex gap-2 items-center">
                    <label htmlFor=" whitespace-nowrap font-semibold">Category :</label>
                ...
                <Button type="submit" gradientDuoTone={'purpleToPink'}>Apply filter</Button>
            </form>
        </div>
        <div className="w-full">
            ...
            <div className="p-7  flex flex-wrap gap-4">
                ...
                }
                {
                    ...
                    className="text-teal-500 text-lg w-full text-center ">
                        Show More
                    </button>
                }
            </div>
